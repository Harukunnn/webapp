...
// des améliorations du module J.E.U. et des indicateurs Kairos. Incrémentez
...
// La liste des ressources à mettre en cache. Inclut app.js, jeu.js et
...
const ASSETS = ['./','./index.html','./styles.css','./app.js?v=3.4.25','./jeu.js?v=3.4.25','./prioritizer.js?v=3.4.25','./jeu.html','https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js'];
